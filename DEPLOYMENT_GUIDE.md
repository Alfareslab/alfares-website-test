# دليل النشر - مركز الفارس v4.0.0

## 📋 نظرة عامة

هذا الدليل يشرح كيفية نشر موقع مركز الفارس v4.0.0 (مع الشات بوت) على Netlify.
...
- ✅ **Netlify Functions** - دعم الشات بوت بدون سيرفر
...
git init
git add .
git commit -m "Initial commit - v4.0.0 with AI Chatbot"

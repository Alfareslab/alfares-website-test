// netlify/functions/chat.js - العقل البرمجي (Netlify Function)
// هذا الملف يحتوي على منطق Gemini وإشعارات Telegram و WhatsApp المحدثة.
...
"قواعد الحوار:\n" +
"1. ابدأ دائمًا بسؤال ترحيبي عام باللغتين: \"مرحباً بك في مركز الفارس | Welcome to Al-Fares Center. أنا مساعدك التقني، كيف يمكنني مساعدتك اليوم؟\"\n" +
...
async function sendReportToTelegram(history, finalResponse) {
    ...
    try {
        ...
        console.error('Error during report extraction or sending to Telegram:', error);
        return '';
    }
}
